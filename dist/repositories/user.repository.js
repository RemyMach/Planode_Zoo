...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.getUser = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var userController;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserRepository.getUserByIdAndVerifyJob = function (id, job_labels) {
        return __awaiter(this, void 0, void 0, function () {
            var userController;
            var _a;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, userController.user.findOne({
                                ...
                                include: [{
                                        ...
                                        attributes: ['label'],
                                        where: (_a = {},
                                            _a[sequelize_1.Op.or] = { label: job_labels },
                                            _a)
                                    }]
                            })];
    ...
    UserRepository.updateUser = function (token, props) {
        return __awaiter(this, void 0, void 0, function () {
            var userController, user, email_user, props_convert, user_modified;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.getInstance()];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, userController.getUser(token)];
                    case 4:
                        user_modified = _a.sent();
                        return [2 /*return*/, user_modified];
                }
            });
        });
    };
    UserRepository.updateUserpassword = function (token, new_password) {
        return __awaiter(this, void 0, void 0, function () {
            var userController, user, email_user, user_modified;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.getInstance()];
                    case 1:
