...
exports.HealthcareFixture = void 0;
var models_1 = require("../../models");
var HealthcareFixture = /** @class */ (function () {
    function HealthcareFixture() {
    }
    HealthcareFixture.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (HealthcareFixture.instance === undefined) {
                    HealthcareFixture.instance = new HealthcareFixture();
                }
                return [2 /*return*/, HealthcareFixture.instance];
            });
        });
    };
    ;
    HealthcareFixture.prototype.fillTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var manager, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        manager = _d.sent();
                        _a = this;
                        return [4 /*yield*/, manager.healthcare.create({
                    ...
                    case 2:
                        _a.healthcare_spanish_flu = _d.sent();
                        _b = this;
                        return [4 /*yield*/, manager.healthcare.create({
                    ...
                    case 3:
                        _b.healthcare_diarrhea = _d.sent();
                        _c = this;
                        return [4 /*yield*/, manager.healthcare.create({
                    ...
                    case 4:
                        _c.healthcare_wound = _d.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    HealthcareFixture.prototype.destroyFieldsTable = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var manager;
    ...
    return HealthcareFixture;
}());
exports.HealthcareFixture = HealthcareFixture;
