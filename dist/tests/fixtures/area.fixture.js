...
exports.AreaFixture = void 0;
var models_1 = require("../../models");
var type_fixture_1 = require("./type.fixture");
var AreaFixture = /** @class */ (function () {
    function AreaFixture() {
    }
    AreaFixture.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (AreaFixture.instance === undefined) {
                    AreaFixture.instance = new AreaFixture();
                }
                return [2 /*return*/, AreaFixture.instance];
            });
        });
    };
    ;
    AreaFixture.prototype.fillTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var manager, typeFixture, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        typeFixture = _c.sent();
                        _a = this;
                        return [4 /*yield*/, manager.area.create({
                                name: "savanna park",
    ...
    AreaFixture.prototype.destroyFieldsTable = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var manager;
...
exports.AreaFixture = AreaFixture;
