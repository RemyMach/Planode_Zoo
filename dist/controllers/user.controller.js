...
var UserController = /** @class */ (function () {
    function UserController(user, job, role, session) {
        this.user = user;
        this.job = job;
        this.role = role;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user_repository_1.UserRepository.getUser(token)];
                    case 1:
                        user = _a.sent();
                        if (user !== null) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcrypt_1.compare(props.password, user.password)];
                    case 2:
                        isSamePassword = _a.sent();
                        if (!isSamePassword) {
                            throw new Error("The password is invalid");
                        }
                        return [4 /*yield*/, user_repository_1.UserRepository.updateUserpassword(token, props.new_password)];
